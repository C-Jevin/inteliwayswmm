...
*/
@RestController
@RequestMapping("/shpyan")
public class ShpyanController {
    @Resource
    ...
    public Result delete(@PathVariable Integer id) {
        shpyanService.deleteById(id);
        return ResultGenerator.genSuccessResult();
    }

    @PutMapping
    public Result update(@RequestBody Shpyan shpyan) {
        shpyanService.update(shpyan);
        return ResultGenerator.genSuccessResult();
    }

    @GetMapping("/{id}")
    public Result detail(@PathVariable Integer id) {
        Shpyan shpyan = shpyanService.findById(id);
        return ResultGenerator.genSuccessResult(shpyan);
    }
