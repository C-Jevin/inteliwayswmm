...
*/
@RestController
@RequestMapping("/shppaishui")
public class ShppaishuiController {
    @Resource
    ...
    public Result delete(@PathVariable Integer id) {
        shppaishuiService.deleteById(id);
        return ResultGenerator.genSuccessResult();
    }

    @PutMapping
    public Result update(@RequestBody Shppaishui shppaishui) {
        shppaishuiService.update(shppaishui);
        return ResultGenerator.genSuccessResult();
    }

    @GetMapping("/{id}")
    public Result detail(@PathVariable Integer id) {
        Shppaishui shppaishui = shppaishuiService.findById(id);
        return ResultGenerator.genSuccessResult(shppaishui);
    }
