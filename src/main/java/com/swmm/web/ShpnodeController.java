...
*/
@RestController
@RequestMapping("/shpnode")
public class ShpnodeController {
    @Resource
   ...
   /* @PostMapping
    ...
    public Result delete(@PathVariable Integer id) {
        shpnodeService.deleteById(id);
        return ResultGenerator.genSuccessResult();
    }

    @PutMapping
    public Result update(@RequestBody Shpnode shpnode) {
        shpnodeService.update(shpnode);
        return ResultGenerator.genSuccessResult();
    }

    @GetMapping("/{id}")
    public Result detail(@PathVariable Integer id) {
        Shpnode shpnode = shpnodeService.findById(id);
        return ResultGenerator.genSuccessResult(shpnode);
    }
